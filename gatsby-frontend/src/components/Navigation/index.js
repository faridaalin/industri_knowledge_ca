...
const Navigation = ({ home, navLinksRef, navbarIconRef, logoRef }) => {
  ...
  return (
    <StyledHeader className="navigation" navbarColor={navbarColor} >
      {home ? (
        ...
        <>
          <Link to="/" className="logo" aria-label="home"  ref={logoRef}>
            <img src={Logo} alt="Farida Alin logo" />
          </Link>
          <nav className="menu" >
            <div
            ...
            <ul className={`menu__items ${showMenu ? "show" : ""}`} ref={navLinksRef}>
